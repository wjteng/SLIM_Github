...
P1 = [12,9,6,11,8,13,2,1,4,15,14,3,0,5,10,7];
#P1 = [13,8,7,12,9,14,3,16,5,2,15,4,1,6,11,10]; need to shift
#P2 = [5,8,16,12,3,11,2,13,4,1,14,6,9,15,7,10]; need to shift
#P2 = [10,7,5,9,1,12,15,2,13,16,6,4,8,11,14,3]; need to shift
P =   [7,13,1,8,11,14,2,5,4,10,15,0,3,6,9,12];

S =  [12,5,6,11,9,0,10,13,3,14,15,8,4,7,1,2];

#LCB-IoT S
S1 =  [0,8,6,13,5,15,7,12,4,14,2,3,9,1,11,10];
